#!/usr/bin/env python3
"""Standalone harness resilience tests for Qwen3.8-27B + mtplx.

Runs *outside* Kilo against the OpenAI-compatible mtplx API (default :8766).

Usage:
  ./2_start_mtplx.sh                 # server already up
  python3 test_harness.py
  python3 test_harness.py --base http://127.0.0.1:8766 --strict
  ...
  python3 test_harness.py --model qwen3.8-27b-mtplx
...
DEFAULT_MODEL = "qwen3.8-27b-mtplx"
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="Qwen3.8-27B mtplx harness smoke tests")
    ap.add_argument("--base", default=DEFAULT_BASE, help="mtplx API base URL")
    ap.add_argument(
        "--model",
        default=DEFAULT_MODEL,
        help="Model id (default qwen3.8-27b-mtplx; auto-resolved from /v1/models)",
    )
    ap.add_argument(
        "--gate",
        action="store_true",
    ...
    print("Qwen3.8-27B mtplx harness tests")
    print(
