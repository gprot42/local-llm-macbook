#!/usr/bin/env bash
# =============================================================================
# install-opencode-json.sh — Sync GLM-4.7-Flash Heretic into OpenCode config
#
# Merges the glm provider from ./opencode.json into
# ~/.config/opencode/opencode.json (preserves your other providers).
# Sets model + small_model to glm/glm-4.7-flash-heretic-q8.
#
# Usage:
