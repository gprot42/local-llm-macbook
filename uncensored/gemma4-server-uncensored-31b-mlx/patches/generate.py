...
# A stream on the default device just for generation.  Refresh it at generation
# entry so worker-thread media requests do not reuse an import-thread stream.
generation_stream = mx.new_stream(mx.default_device())


def _refresh_generation_stream():
    """Return a generation stream valid in the current thread."""
...
def generate_step(
    ...
    **kwargs,
    ...
    stream = _refresh_generation_stream()
