...
# Qwen3.5-122B-A10B MLX ~3–4 bit packs are typically 55–75 GB of weights.
MIN_EXPECTED_BYTES = 45_000_000_000
...
def validate(model_dir: Path) -> tuple[list[str], list[str], int]:
    ...
    if shards and not errors:
        ...
        # Heuristic: 122B MoE MLX 3–4 bit should be well over ~45 GB.
